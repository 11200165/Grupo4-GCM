    ...
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSender.SendEmailAsync(
                email,
                "Confirmar correo actualizado",
                $"Verifique su correo <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>click aqui</a>.");

            StatusMessage = "Ingrese a su corre y verifique su correo.";
            return RedirectToPage();
        }
    }
}
